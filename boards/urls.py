...
from boards.views.groups import (
    ...
    group_create,
    group_detail,
    group_theme_gallery_update,
    group_visibility_update,
    group_join,
...
urlpatterns = [
    ...
    path("comunidades/<slug:slug>/visual/", group_theme_gallery_update, name="group_theme_gallery_update"),
    path("comunidades/<slug:slug>/privacidade/", group_visibility_update, name="group_visibility_update"),
    path("comunidades/<slug:slug>/entrar/", group_join, name="group_join"),
    path("comunidades/<slug:slug>/pedidos/<int:user_id>/aprovar/", group_request_approve, name="group_request_approve"),
    path("comunidades/<slug:slug>/pedidos/<int:user_id>/recusar/", group_request_deny, name="group_request_deny"),
    path("comunidades/<slug:slug>/convidar/", group_invite_friends, name="group_invite_friends"),
    path("comunidades/<slug:slug>/membros/<int:user_id>/remover/", group_member_remove, name="group_member_remove"),
    path("comunidades/<slug:slug>/membros/<int:user_id>/cutucar/", group_member_nudge, name="group_member_nudge"),
    path("comunidades/<slug:slug>/membros/<int:user_id>/papel/", group_member_role_update, name="group_member_role_update"),
    path("comunidades/<slug:slug>/publicar/", group_post_create, name="group_post_create"),
    path("comunidades/<slug:slug>/mentions/", group_mention_search, name="group_mention_search"),
    path("comunidades/<slug:slug>/posts/<int:post_id>/apagar/", group_post_delete, name="group_post_delete"),
