...
urlpatterns = [
    ...
    # Recuperação de senha (força templates seus para não cair no admin)
    # - email_template_name: versão texto puro (evita aparecer <p> no Gmail)
    # - html_email_template_name: versão HTML (para clientes que renderizam)
    path(
    ...
    # (Opcional) criação de usuário (se ainda usa isso em algum lugar)
